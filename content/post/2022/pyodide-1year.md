...
흥미로운 도구들이 많이 나왔다.
아직 다양한 도구들에 대한 교통 정리가 되지 않은 느낌이 들기는 하지만,
...
일반 개발자들에게도 브라우저에서 파이썬을 실행한다는 개념이 널리 알려졌다.
작년까지만 해도 Pyodide를 검색하면 한국어로 된 글은 전무했을 정도였는데,
이제는 한국어로 된 PyScript 소개글을 찾기 어렵지 않다.

한편으로, 최근 Python의 발전에는 마이크로소프트가 많은 기여를 하고 있는데
...
지금 다시보니 다큐멘터리처럼 느껴지는 것이 세상 사는 것이
다 비슷하다는 생각이 든다.
