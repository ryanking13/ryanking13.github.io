...
유명한 여러 HTML 포맷팅 도구들이 유저 몰래 특정 사이트로 향하는 링크를 삽입해서,
...
모바일과 PC 환경을 통합하려는 의도가 느껴지는 부분인 것 같습니다.

다른 흥미로운 기능으로는 윈도우즈에서 안드로이드 앱을 네이티브로 지원하는 WSA(Windows Subsystems for Android)인데요.
